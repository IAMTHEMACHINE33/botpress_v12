...
export default class MyMainView extends React.Component {
  ...
  async fetch() {
    ...
    // const result = await this.props.bp.axios.get('mod/custom/title')
    // console.log(result)
    // this.setState({ result })
    // return result
  }
  async fetchConfig() {
    const config = await this.props.bp.axios.get('/mod/custom/config')
    this.setState({ config: config.allowedMimeTypes })
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* <a href="/assets/modules/custom/qna.xlsx" download>
