...
export class HandleExcel extends React.Component {
  ...
  //   console.log('bp', this.props)
  //   const axiosConfig = await this.props.bp.http.getAxiosConfigForBot(event.botId)
  //   console.log('axiosConfig', axiosConfig)
  //   const upload = await axios.post('mod/custom-module-rijan/upload', data, axiosConfig)
  ...
  async uploadFile(file) {
    const data = new FormData()
    data.append('file', file)
    data.append('allowedMimeTypes', this.state.config)
    // console.log('upload_file', file)
    const upload = await this.props.bp.axios.post('mod/custom-module-rijan/upload', data)
    console.log('upload', upload)
    return
  }
